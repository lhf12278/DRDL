...
_C.MODEL.EVAL_PERIOD = int(10)

# -------optimizer params-----------
_C.MODEL.ADAM_LR = 0.00035
_C.MODEL.ADAM_BEAT1 = 0.5
_C.MODEL.C_LR = 0.000029
...
# ---------- hyperparameter -------
_C.MODEL.WEIGHT_LAMBDA1 = 1
_C.MODEL.WEIGHT_LAMBDA2 = 0.05
_C.MODEL.WEIGHT_ALPHA1 = 0.1
_C.MODEL.WEIGHT_BETA1 = 10
_C.MODEL.WEIGHT_BETA2 = 20

_C.MODEL.WEIGHT_ALPHA = 0.01
_C.MODEL.WEIGHT_BETA = 1
_C.MODEL.WEIGHT_LAMBDA = 0.01
_C.MODEL.WEIGHT_TAO = 0.01
...
# _C.DATASETS.CAMS_S = int(15)
# _C.DATASETS.NUM_CLASSES_S = int(0)

# List of target datasets
# _C.DATASETS.TNAMES = ('dukemtmc')
# _C.DATASETS.CAMS_T = int(8)
#
_C.DATASETS.TNAMES = ('market1501')
_C.DATASETS.CAMS_T = int(6)

# _C.DATASETS.TNAMES = ('msmt17')
# _C.DATASETS.CAMS_T = int(15)

# _C.DATASETS.TNAMES = ('prid')
# _C.DATASETS.CAMS_T = int(2)

# _C.DATASETS.TNAMES = ('grid')
# _C.DATASETS.CAMS_T = int(6)
...
_C.OUTPUT_DIR = osp.join(working_dir, "logs/Duke2Market")
